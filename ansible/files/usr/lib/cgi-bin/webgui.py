...
device_id_static = '28-00000448d1a2' #long wire
#device_id_static = '28-000004488f83'
...
def get_data(interval,device_id):
    ...
    if interval == None:
        ...
        curs.execute("SELECT * FROM temps WHERE id = '%s' AND timestamp>datetime('2015-06-06','-%s hours')" % (device_id,interval))
...
def main():
    ...
    # get data from the database
    records=get_data(option,device_id_static)
